...
static void	constructorTests() {
	...
	// 	std::stack< int, std::stack<int> >		intStack(intVector);
...
static void	memberFunctionTests() {
	...
	// 	floatVector.push_back(42.42);
	// 	std::stack<float>	floatStack(floatVector);
...
static void	nonMemberFunctionTests() {
	...
	// 	std::stack<char>	charStack1(charVector1);
	// 	std::stack<char>	charStack2(charVector2);
