...
static void	constructorTests() {
	{
		...
		ft::stack< int, ft::vector<int> >	intStack(intVector);
	...
	}
	{
		std::cout << "\033[36m";
		std::cout << "Create an int vector wich contains 5 elements and create a stack with this vector" << std::endl;
		std::vector<int>	intVector(5, 67);
		std::stack< int, std::vector<int> >		intStack(intVector);
...
static void	memberFunctionTests() {
	{
		...
		ft::stack< float, ft::vector<float> >	floatStack(floatVector);
	...
	}
	{
		std::cout << "\033[36m";
		std::cout << "Create an float vector wich contains 5 elements and create a stack with it, the last element is 42.42" << std::endl << std::endl;
		std::vector<float>	floatVector(4, 96.8);
		std::stack<int>		emptyStack;

		floatVector.push_back(42.42);
		std::stack< float, std::vector<float> >	floatStack(floatVector);
...
static void	nonMemberFunctionTests() {
	{
		...
		ft::stack< char, ft::vector<char> >	charStack1(charVector1);
		ft::stack< char, ft::vector<char> >	charStack2(charVector2);
	...
	}
	{
		std::cout << "\033[36m";
		std::cout << "Create two stacks that contains the same contents but a different size" << std::endl;
		std::vector<char>						charVector1(5, 'a');
		std::vector<char>						charVector2(6, 'a');
		std::stack< char, std::vector<char> >	charStack1(charVector1);
		std::stack< char, std::vector<char> >	charStack2(charVector2);
