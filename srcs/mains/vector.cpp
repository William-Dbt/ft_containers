...
static void	constructorTests() {
	...
	}
	{
		...
		std::cout << std::endl;
		std::cout << "Initialized size and value constructor (to 42.42):" << std::endl;
		std::vector<float>	floatVector(5, 42.42);
		...
		std::vector<int>	intItVector(stdVector.begin(), stdVector.end());
		...
		std::cout << std::endl;
		std::cout << "Copy (from intItVector) constructor:" << std::endl;
		std::vector<int>	intCopyVector(intItVector);
		...
		std::cout << std::endl;
		std::cout << "Is operator= works? Let's copy the floatVector:" << std::endl;
		std::vector<float>	cpFloatVector(5, 52.52);
...
static void	iteratorTests() {
	...
	}
	{
		...
		std::vector<int>::iterator	it_begin = intVector.begin();
		std::vector<int>::iterator	it_end = intVector.end();
		...
		std::cout << std::endl << std::endl;
		std::cout << "Let's fill a vector of 5 elements and print them with const iterator:" << std::endl;
		std::vector<int>				intConstVector(5);

		for (int i = 0; i < (int)intConstVector.size(); i++)
			intConstVector[i] = i;

		std::vector<int>::const_iterator	itconst_begin = intConstVector.begin();
		std::vector<int>::const_iterator	itconst_end = intConstVector.end();
...
static void	modifiersTests() {
	...
	}
	{
		...
		std::cout << std::endl << std::endl;
		std::vector<std::string>				namesVector(3);
		...
		std::cout << "Create two vectors and swap their contents:" << std::endl;
		std::vector<float>	vectorA(5, 42.42);
		std::vector<float>	vectorB(2, 84.84);
...
static void	nonMemberFunctionsTests() {
	...
	}
	{
		...
		std::cout << "Create two vectors A and B:" << std::endl;
		std::vector<int>	vectorA(5, 100);
		std::vector<int>	vectorB(5, 100);
		...
		std::cout << std::endl;
		std::cout << "Create third vector to test >= and <= equal operator:";
		std::vector<int>	vectorC(vectorB);
