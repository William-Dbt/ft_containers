...
include_path="../ -I../srcs/templates/ -I../includes/ -I../includes/vector/ -I../includes/stack/ -I../includes/map/ -I../srcs/templates/vector/ -I../srcs/templates/stack/ -I../srcs/templates/map/"
srcs="srcs"
